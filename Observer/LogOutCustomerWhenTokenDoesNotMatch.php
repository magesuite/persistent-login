...
class LogOutCustomerWhenTokenDoesNotMatch implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer): void
    {
        ...
        try {
            $this->deleteCustomerToken((int) $this->customerSession->getCustomerId(), $persistentSession);
    ...
    protected function deleteCustomerToken(int $customerId, \Magento\Persistent\Model\Session $persistentSession): void
    {
